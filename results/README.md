...
![Ну нет ее и все! Отстань!](/result/LOO(k)kNN(2)).png) ![Ну нет ее и все! Отстань!](/result/kNN(res)).png)

Результаты **kwNN**:

![Ну нет ее и все! Отстань!](/result/LOO(k)kwNN(2)).png) ![Ну нет ее и все! Отстань!](/result/kwNN(res)).png)
